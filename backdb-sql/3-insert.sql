...
VALUES
  ...
  ('test2', 'Никитин Ярослав', '12345678'),
  ('test3', 'Костина Вероника', '12345678'),
  ('test4', 'Назаров Леонид', '12345678'),
  ('test5', 'Леонов Максим', '12345678'),
  ('test6', 'Гаврилова Яна', '12345678'),
  ('test7', 'Котова София', '12345678'),
  ('test8', 'Дьяконова Полина', '12345678'),
  ('test9', 'Баранов Михаил', '12345678'),
  ('test10', 'Акимов Марк', '12345678'),
  ('test11', 'Попова Полина', '12345678'),
  ('test12', 'Горюнов Ярослав', '12345678'),
  ('test13', 'Кузнецов Константин', '12345678'),
  ('test14', 'Степанов Григорий', '12345678'),
  ('test15', 'Иванов Иван', '12345678');
